         ...
         <div key={i} className="col-md-3 m-4">
           <div className="card cardAkafi">
             ...
             <div className="card-body">
               <h2 className="card-title text-dark text-decoration-underline">{singleGood.item_name}</h2>
               <p className="card-text text-justify">{`Seller : ${singleGood.user_firstName} ${singleGood.user_firstLast} `} 
               </p>
