...
function MtechSecitonFileUpload() {
  ...
  let formSubmitter = (e) => {
    ...
    let linkToSend = `${axiosInstance.defaults.baseURL}/user/mtechUpload`;
    axiosInstance({
      method: "POST",
      url: `/user/mtechUpload`,
      data: formData,
  ...
  let handleChange = (e) => {
    switch (e.target.name) {
      ...
      case "Course_file":
        setUserData((pre) => {
          return { ...pre, Course_file: e.target.files[0] };
        });
        break;
      default:
        break;
          ...
          <div className="notePart h-100 col-md-4 col-sm-12  ">
            ...
            <ul className="forUl">
              ...
              <ul>
                <h5>
                  {" "}
                  Your Can Click On The Following Buttons For File Conversion
                </h5>
