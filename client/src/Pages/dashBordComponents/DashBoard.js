...
useEffect(() => {
  ...
  { notifications.map((singleNotification,i)=>{
     collector = collector + ` Notification By: ${singleNotification.user_first_name}, Notification : ${singleNotification.user_notification_message}, Date Of Notification : ${singleNotification.date_of_notification} |`
