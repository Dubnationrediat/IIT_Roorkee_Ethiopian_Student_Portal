      ...
      <div className="d-md-flex main-box-wraper">
        <div>
          ...
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/Reg._Plan_International__PG__Ph.D..pdf"
              download
            >
              Download pdf
            </a>
          ...
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/1.Registration_for_new_PHD_student.pdf"
              download
            >
              Download pdf
            </a>
          ...
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/The steps and doc required for accadamic registration.pdf"
              download
            >
              Download pdf
            </a>
          ...
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/7.Advisor_Selection_Process.pdf"
              download
            >
              Download pdf
            </a>
          ...
          <div className="box">
            ...
            <a href="../fromAcadamicTeam/FRRO Annex II_01022018.pdf" download>
              Download pdf
            </a>
          </div>
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/Fact_Sheet_IIT_Roorkee_2023.pdf"
              download
            >
              Download pdf
            </a>
        ...
        <div>
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/8.Useful Locations and Links.pdf"
              download
            >
              Download pdf
            </a>
          ...
          <div className="box">
            ...
            <a
              href="../fromAcadamicTeam/How_to_connect_internet_for_Windows.pdf"
              download
            >
              Download pdf
            </a>
            <br />
            <a href="../fromAcadamicTeam/Network_Security_Setup.rar" download>
              {" "}
              Network security setup download
            </a>
            <br />
            <a href="../fromAcadamicTeam/anyconnect.zip" download>
              Any connect software download
            </a>
          </div>
          <div className="box">
            <h5>Software requisition portal Info</h5>
            <a href="../fromAcadamicTeam/ICC Faculty Manual.pdf" download>
              Download pdf
            </a>
          </div>
          <div className="box">
            <h5>IITR WIFI registration steps</h5>
            <a href="../fromAcadamicTeam/IITR WIFI Registration.pdf" download>
              Download pdf
            </a>
            <h5>
              {" "}
          ...
          <div className="box">
            ...
            <a href="../fromAcadamicTeam/Sim card Subscription_2.pdf" download>
              Download pdf
            </a>
          </div>
        </div>
