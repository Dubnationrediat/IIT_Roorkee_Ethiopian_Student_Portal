    ...
    return (
      <>
        <div className="deleteConfirm">
          <h2 className="pt-3 font-weight-bold text-decoration-underline">
            Are you sure?
          </h2>
          <p className="p-1 h5 text-center text-justify font-weight-bold">
            If you choose to delete your account, you will no longer have access
            to login and use any of the resources on the platform. However, any
            resources that you have uploaded prior to deleting your account will
            remain on the platform with your username or other identifying
            information associated with them
          </p>

          <div className="d-flex justify-content-center align-items-center py-3">
            <div className="m-4">
              <Button onClick={deleteProfileHandler} className="bg-danger">
                Yes, Delete Account
              </Button>
            </div>
            <div className="m-4">
