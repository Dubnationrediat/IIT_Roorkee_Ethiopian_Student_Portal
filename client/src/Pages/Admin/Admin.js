...
function Admin() {
  ...
  const usersForAdmin = async () => {
    try {
      const responceForUsers = await axiosInstance.get(
        "/admin/adminManagerUsers"
      );
  ...
  const goodsForAdmin = async () => {
    try {
      const responceForMarket = await axiosInstance.get("/admin/adminGoods");
  ...
  const notificationForAdmin = async () => {
    try {
      const responceForNotification = await axiosInstance.get(
  ...
  const phdForAdmin = async () => {
    try {
      const responceForPhd = await axiosInstance.get("/admin/adminPhd");
  ...
  const mtechForAdmin = async () => {
    try {
      const responceForMtech = await axiosInstance.get("/admin/adminMtech");
  ...
  const btechForAdmin = async () => {
    try {
      const responceForBtech = await axiosInstance.get("/admin/adminBtech");
  ...
  async function toDeleteEmailOnly(id) {
    ...
    await axiosInstance({
      method: "DELETE",
      url: `/admin/deleteUserEmailOnly/${id}`,
    });
    usersForAdmin();
  }
  //* For Delete
  async function toDeleteNotification(id) {
    ...
    await axiosInstance({
      method: "DELETE",
      url: `/admin/deleteNotification/${id}`,
    });
    notificationForAdmin();
  }
    ...
    <>
      <div className="my-2 ">
              ...
              let staffDataDisplay = (
                <TableBody className="" key={j}>
                  ...
                  <div className="d-flex mx-0">
                    <Button
                      onClick={() => toDeleteUserInfo(data.userInfo_ID)}
                      className="btn-danger m-md-3 m-1"
                    >
                      Delete completely
                    </Button>
                    <Button
                      onClick={() => toDeleteEmailOnly(data.userInfo_ID)}
                      className="btn-danger m-md-3 m-1"
                    >
                      Delete Email Only
                    </Button>
                    ...
                    <Link
                      className="notificationSubmit m-md-3 m-1 "
                      to={`/updateUserInfoAdmin/${data.userInfo_ID}`}
                    >
                      Update
                    </Link>
                  </div>
        ...
        <TableContainer className="toShowStaffForward m-2" component={Paper}>
          ...
          <div></div>
          <Table
            className="tables justify-content-between"
          ...
          >
            <TableHead className="background">
              <TableRow className="background d-md-flex">
                <div className="">
                  <StyledTableCell
                    className="border px-md-5 py-md-4"
                    align="center"
                  >
                  ...
                  <StyledTableCell className="border px-md-5 " align="center">
                    Item id
                  </StyledTableCell>
                </div>
                <div>
                ...
                <div> */}
                  ...
                  <StyledTableCell className="border px-md-3" align="center">
                    userInfo ID
                  </StyledTableCell>
                </div>
                <div>
                  <StyledTableCell className="border px-md-4" align="center">
                    user Indian Number
                  </StyledTableCell>
                  <StyledTableCell className="border px-md-4" align="center">
                    user Last name
                ...
                <TableBody className="" key={j}>
                  <StyledTableRow className="backgrounds d-md-flex d-sm-block  ">
                    ...
                    <div className="table-column">
                      ...
                      <StyledTableCell className="border" align="center">
                        {data.user_whatsappNumber}
                      </StyledTableCell>
                    </div>
                  </StyledTableRow>
                  <div className="d-flex">
                    <Button
                      onClick={() => toDeleteGoods(data.item_id)}
                      className="btn-danger m-3 px-5"
                    >
                      Delete
                    </Button>
                    <Link
                      className="notificationSubmit m-3"
                      to={`/updateUserGoodsAdmin/${data.item_id}`}
                    >
                      Update
                    </Link>
                  </div>
        ...
        <TableContainer className="toShowStaffForward m-2" component={Paper}>
          ...
          <div></div>
          <Table
            className="tables tabel2  "
            aria-label="customized table  mx-md-5"
          >
                ...
                <TableBody className="" key={j}>
                  <StyledTableRow className="backgrounds  d-sm-block  ">
                    <div className="mx-md-5">
                      <StyledTableCell
                        className="border px-md-5"
                        align="center"
                      >
                        {data.notification_id}
                      </StyledTableCell>
                      <StyledTableCell align="center" className="px-md-5">
                        {data.userInfo_ID}
                      </StyledTableCell>
                      <StyledTableCell
                        className="border px-md-5 "
                        align="center"
                      >
                        {data.user_notification_message}
                      </StyledTableCell>
                      <StyledTableCell align="center" className="px-md-5">
                        {data.date_of_notification}
                      </StyledTableCell>
                  ...
                  <div className="d-flex">
                    <Button
                      onClick={() => toDeleteNotification(data.notification_id)}
                      className="btn-danger btn-danger1 m-md-2"
                    >
                      Delete
                    </Button>

                    <Link
                      className="notificationSubmit "
                      to={`/updateNotification/${data.notification_id}`}
                    >
                      Update
                    </Link>
                  </div>
            ...
            <TableHead className="background">
              <TableRow className="background  d-md-flex ">
                <div className="">
                  ...
                  <StyledTableCell align="center" className="border px-md-5">
                    Course given by
                  </StyledTableCell>
                  <StyledTableCell className="border px-md-5" align="center">
                    Course name
                  ...
                  <StyledTableCell className="border py-4" align="center">
                    Department
                  </StyledTableCell>
                  <StyledTableCell className="border px-md-5" align="center">
                    Document id
            ...
            {Btech.map((data, j) => {
              let staffDataDisplay = (
                <TableBody className="" key={j}>
                  ...
                  <div className="d-flex">
                    <Button
                      onClick={() => toDeleteBTech(data.Document_id)}
                      className="btn-danger btn-danger1 m-3"
                    >
                      Delete
                    </Button>
                    ...
                    <Link
                      className="notificationSubmit"
                      to={`/updateBtechAdmin/${data.Document_id}`}
                    >
                      Update
                    </Link>
                  </div>
            ...
            <TableHead className="background">
              <TableRow className="background d-md-flex ">
                <div>
                  ...
                  <StyledTableCell align="center px-md-5">
                    Course given by
                  </StyledTableCell>
                  <StyledTableCell className="border px-md-5" align="center">
                    Course name
            ...
            {Mtech.map((data, j) => {
              let staffDataDisplay = (
                <TableBody className="" key={j}>
                  ...
                  <div className="d-flex">
                    <Button
                      onClick={() => toDeleteMTech(data.Document_id)}
                      className="btn-danger btn-danger1 m-3 "
                    >
                      Delete
                    </Button>
                    <Link
                      className="notificationSubmit"
                      to={`/updateMtechAdmin/${data.Document_id}`}
                    >
                      Update
                    </Link>
                  </div>
        ...
        <TableContainer className="toShowStaffForward m-2" component={Paper}>
          ...
          <div></div>
          <Table
            className="tables  mx-md-3 justify-content-between"
            aria-label="customized table"
          >
            <TableHead className="background">
              <TableRow className="background d-md-flex ">
            ...
            {Phd.map((data, j) => {
              let staffDataDisplay = (
                <TableBody className="" key={j}>
                  ...
                  <div className="d-flex">
                    <Button
                      onClick={() => toDeletePhd(data.Document_id)}
                      className="btn-danger btn-danger1 m-3"
                    >
                      Delete
                    </Button>
                    ...
                    <Link
                      className="notificationSubmit"
                      to={`/updatePhdAdmin/${data.Document_id}`}
                    >
                      Update
                    </Link>
                  </div>
